 ...
 * @author Kahle
 */
public class JavaGenerateHelper extends AbstractAttributable implements Generator {
    ...
    public static String getTypeMapping(String columnClassName, String columnType) {
        ...
        if (checkColumnType) {
            ...
            result = TYPE_MAPPINGS.get(columnType);
        }
    ...
    private void initializeTableList() throws Exception {
        ...
        for (TableMeta table : tableMetaList) {
            ...
            for (ColumnMeta columnMeta : columnMetaList) {
                ...
                columnClassName = JavaGenerateHelper.getTypeMapping(columnClassName, columnType);
    ...
    public void generate() throws GenerateException {
        try {
            if (CollectionUtils.isEmpty(generatorList)) { return; }
