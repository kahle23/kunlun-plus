...
public class DataUtilsTest {
    ...
    public void test() {
        ...
        List<Menu> vos = DataUtils1.multilevelList(list, "sonMenuList", "code", "parentCode");
    ...
    public void test1() {
        ...
        System.err.println(">>>>>>>>>>>>>> multilevel : ");
        List<Menu> vos = DataUtils1.multilevelList(list1, "sonMenuList", "code", "parentCode", "module");
        System.err.println(JSON.toJSONString(vos, true));
    }
